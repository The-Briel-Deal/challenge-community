...
function BasicModal(props) {
  ...
  return (
    <div>
      <Button style={{ color: "black" }} className="bot-links" onClick={handleOpen}>
        Learn More
      </Button>
      <Modal
        open={open}
      ...
      >
        <Box sx={style} className="popup-top">
          <div>
            <Typography style={{fontSize: '2 rem'}} id="modal-modal-title" variant="h6" component="h2">
              {props.name}
            </Typography>
          </div>
  ...
  return (
      ...
      <Card className="card-whole" sx={{ minWidth: 275 }}>
        <div className="card-top">
          <CardContent>
            <Typography
              sx={{ fontFamily: "Red Hat Mono", color: "white" }}
              variant="h5"
              component="div">
              {props.name}
            </Typography>
        ...
        <CardActions>
          ...
          <Button style={{ color: "black" }} className="bot-links">JOIN</Button>
        </CardActions>
      </Card>
